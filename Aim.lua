...
updateContent = function()
    ...
    if CurrentCategory == "Combat" then
        panel = createPanel("Aim Assist / FOV", 335)
...
RunService.RenderStepped:Connect(function(deltaTime)
    ...
    FOVGui.BackgroundTransparency = Config.FOVFilled and 0.88 or 1
